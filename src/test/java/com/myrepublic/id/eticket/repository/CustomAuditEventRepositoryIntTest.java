package com.myrepublic.id.eticket.repository;

import com.myrepublic.id.eticket.EticketApp;
import com.myrepublic.id.eticket.config.Constants;
import com.myrepublic.id.eticket.config.audit.AuditEventConverter;
import com.myrepublic.id.eticket.domain.PersistentAuditEvent;
...
import static com.myrepublic.id.eticket.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

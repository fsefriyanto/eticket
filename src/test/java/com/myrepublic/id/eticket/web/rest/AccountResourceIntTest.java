package com.myrepublic.id.eticket.web.rest;
import com.myrepublic.id.eticket.config.Constants;
import com.myrepublic.id.eticket.EticketApp;
import com.myrepublic.id.eticket.domain.Authority;
import com.myrepublic.id.eticket.domain.PersistentToken;
import com.myrepublic.id.eticket.domain.User;
import com.myrepublic.id.eticket.repository.AuthorityRepository;
import com.myrepublic.id.eticket.repository.PersistentTokenRepository;
import com.myrepublic.id.eticket.repository.UserRepository;
import com.myrepublic.id.eticket.security.AuthoritiesConstants;
import com.myrepublic.id.eticket.service.MailService;
import com.myrepublic.id.eticket.service.dto.UserDTO;
import com.myrepublic.id.eticket.web.rest.errors.ExceptionTranslator;
import com.myrepublic.id.eticket.web.rest.vm.KeyAndPasswordVM;
import com.myrepublic.id.eticket.web.rest.vm.ManagedUserVM;
import com.myrepublic.id.eticket.service.UserService;
...
@SpringBootTest(classes = EticketApp.class)
